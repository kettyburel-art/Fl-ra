...
const ACCOUNTS = {
  // Compte administrateur (Ketty) — mot de passe stocké en SHA-256
  'ketty@flora.app': {
    passwordHash: '44c691169d5a00731ad5b4c2d0c3e27276d92fd83a4045d4a7c54acbb5a999f7',
    role: 'admin',
    name: 'Ketty',
    premium: true
  },
  ...
  'invite@flora.app': {
    passwordHash: '1a285c8f230cdf95395e7483178fdf4a96bef06c41728586d119a49973a5dfc8',
    role: 'beta',
    name: 'Invité·e',
    premium: true
  },
...
// Hash SHA-256 (API native du navigateur)
  ...
  container.innerHTML = entries.map(([date, e]) => {
    ...
    return `
      <div class="hist-entry">
        ...
        ${e.notes ? `<div style="font-size:0.8rem;color:var(--text-mid);margin-top:8px;font-style:italic;">"${escapeHtml(e.notes)}"</div>` : ''}
      </div>`;
  }).join('');
}
...
async function checkCode() {
  ...
  // Codes valides stockés en SHA-256 (illisibles dans le source)
  const VALID_CODE_HASHES = [
    '53a76d07d90b16427ce392cd8792898f11a0881ee91cac9bd4d6c3a0d5ea30e2',
    '7efa373696ccf6d35fe2e654b3759d86bbebac2c50e82f0389df5b77b90678da'
  ];
...
// ============================================================
// PATCH PERF — Debounce de la recherche recettes
// Re-branche l'input en remplaçant le handler inline éventuel.
// ============================================================
(function initSearchDebounce() {
  let _searchDebounce = null;
  function bind() {
    const el = document.getElementById('recette-search');
    if (!el) return;
    el.oninput = function() {
